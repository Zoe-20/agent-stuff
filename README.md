...
* [`reveal.ts`](pi-extensions/reveal.ts) - Finder/Quick Look helper that reveals the latest file reference from the session via Ctrl+F (Finder) or Ctrl+Shift+F (Quick Look on macOS).
